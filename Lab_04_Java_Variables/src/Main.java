public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("The quotient using ints of " + intOperandA + " divided by " + intOperandB + " is " + intQuotient);

        intModulo = intOperandA % intOperandB;
        System.out.println("The remainder (modulo) using ints of " + intOperandA + " and " + intOperandB + " is " + intModulo);
        ...
        System.out.println("The quotient using doubles of " + doubleOperandA + " divided by " + doubleOperandB + " is " + doubleQuotient);

        // Declarations
        int numberOfKidsInFamily = 3;
        boolean isItRaining = false;
        double priceOfGallonGas = 3.79;
        int favoriteNumber = 7;
        double shoeSize = 10.5;
        String birthMonth = "March";
        String fullName = "Shola Ogunleye";

        // Statements
        System.out.println("Number of kids in my family: " + numberOfKidsInFamily);
        System.out.println("Is it raining? " + isItRaining);
        System.out.println("Price of a gallon of gas: $" + priceOfGallonGas);
